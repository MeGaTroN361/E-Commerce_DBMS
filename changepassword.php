...
h1{
    ...
    include 'dbcon.php';
      if(isset($_POST['change_password'])){
        ...
        $cpquery = "UPDATE customer SET C_pass='$password',Confim_pass='$cpassword' WHERE cart_id ='$cart_id'";
        $query = mysqli_query($con,$cpquery);
        if ($query) {
    ...
    <div class="section">
    <div class="box" style="width:397px; height : 340px ;margin: auto">
      ...
      <div class="container">
        ...
        <form action="" method="POST" >
            ...
            <div class="register">
                  <button type="change_password" name="change_password" class="btn btn-primary">Change Password</button>
            </div>
        </form>
    </div>
