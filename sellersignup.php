...
h1{
    ...
    include 'dbcon.php';
      if(isset($_POST['signup'])){
        ...
        $_SESSION['cpassword'] = $scpassword;

        $emailquery = "SELECT * FROM seller WHERE Email = '$semail'";
        ...
        <?php
          ...
          ?>
          <script>
          window.location.href="sellerregister.php";
          </script>
          <?php
          }else{
            ?>
      ...
      <div class="container">
        ...
        <form action="" method="POST" >
            <div class="mb-3 col-md-6">
                    ...
                    <input type="email" class="form-control" id="semail" name="semail" aria-describedby="emailHelp" required>
            </div>
            <div class="mb-3 col-md-6">
    ...
    <p>already have an account?<a href="sellerlogin.php">login</a>
   </p>
      </div>
    </div>  
    </div>
