...
h1{
    ...
    $Phoneno = mysqli_real_escape_string($con,$_POST['PhoneNum']);
    $Address = mysqli_real_escape_string($con,$_POST['Address']);
    $Pincode = mysqli_real_escape_string($con,$_POST['pincode']);
    $long = mysqli_real_escape_string($con,$_POST['longitude']);
    $lati = mysqli_real_escape_string($con,$_POST['latitude']);
    // $pass = password_hash($password,PASSWORD_BCRYPT);
    // $cpass = password_hash($cpassword,PASSWORD_BCRYPT);

    
    $icart = "INSERT INTO cart(Cart_id) VALUES (NULL)";
    $squery = mysqli_query($con,$icart);
    $get_cart_id = "SELECT * FROM cart WHERE Cart_id=(SELECT max(Cart_id) FROM cart);";
    $cart = mysqli_query($con,$get_cart_id);
    $array = mysqli_fetch_array($cart);
    $id = intval($array[0]);

    echo "$id";

    $inserquery = "INSERT INTO customer(Name, Address, Email, Phone_no, Pincode, cart_id, C_pass, Confim_pass, Customer_id,Longitude,Latitude) VALUES ('$fullname','$Address','$email',$Phoneno,$Pincode,$id,'$password','$cpassword',NULL,'$long','$lati')";
    ...
    <div class="box" style="width:397px; height : 80vh ;margin: auto">
      ...
      <div class="container">
        ...
        <div class="mb-3 col-md-6">
                    ...
                    <input type="fullname" class="form-control" id="fullname" name="fullname" aria-describedby="emailHelp" required>
            </div>
            <!-- <div class="mb-3 col-md-6">
            ...
            <div class="mb-3 col-md-6">
                    ...
                    <input type="PhoneNum" class="form-control" id="PhoneNum" name="PhoneNum" aria-describedby="emailHelp" required>
            </div>
            <div class="mb-3 col-md-6">
            ...
            <div class="mb-3 col-md-6">
                ...
                <input type="pincode" class="form-control" id="pincode" name="pincode" style="width: 170px;" required>
            </div>
            ...
            <div class="register11">
                <button type="register1" class="btn btn-primary" name="register" style="width:300px">Register</button>
            </div>
        </form>
    </div>
      </div>
